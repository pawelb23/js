 ...
 window.addEventListener('scroll', function () {
     ...
     if (y >= headerHeight) {
         ...
         //powyżej łapiemy tylko szerokość, przesuwanie względem wysokości jest ustawione na zero


         //document.getElementById('background').style.backgroundPosition = bgPos + 'px' + " " + bgPos +'px';
         //powyższy zapis pokazuje jak możemy złapać obrazek, aby przesuwał się przez szerokość ekranu i przez wysokość ekranu
